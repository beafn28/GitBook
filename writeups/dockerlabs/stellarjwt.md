...
```bash
gobuster dir -u http://172.17.0.2/ -w /usr/share/wordlists/dirbuster/directory-list-lowercase-2.
```
...
Decodificamos esa cadena con esta [página](https://cyberchef.org/#recipe=JWT\_Decode\(\)).
